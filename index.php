            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="nav-link" href="logout.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart</a>
                        </li>
                        <?php } ?>
                        <?php
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="lihatbarang.php?barang=<?php echo $idx->encode($x['id_barang']); ?>"><img class="card-img-top" style="height: 200px;" src="assets/img/<?php echo $x['foto_barang'];?>" alt=""></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                ...
                                <div class="card-footer container">
                                  ...
                                  <div class="col-sm">
                                  <small class="text-muted">
                                        <a href="indexRoute.php?barang=<?php echo $idx->encode($x['id_barang']); ?>&aksi=<?php echo $idx->encode('tambahcart'); ?>">
